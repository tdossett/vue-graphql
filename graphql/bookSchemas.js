...
// Create a GraphQL query type that calls a 
// list of book and single book by ID
...
// For completing CRUD (Create, Read, Update, Delete) operation of the GraphQL,
// we need to add a mutation that contains create, update and delete operations.
// Open and edit `graphql/bookSchemas.js` then add this mutation as GraphQL Object Type
